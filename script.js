...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const videoDatabase = [
        { id: 'Cities Skylines 2 #1', title: 'Cities Skylines 2 - Bienvenue a Lake Arbor #1', thumbnail: 'https://imgur.com/a/2mFUzKC', duration: '20:52', date: '28 juillet 2025', views: 'Non definies vues', description: '🎮 Bienvenue à Lake Arbor sur Cities Skylines 2 !
...
Pour ce premier épisode, nous allons mettre en place le train et la première zone résidentielle.', youtubeLink: '#', credits: { Musique: [ { name: 'Lost in Dreams', by: 'dvine' }, { name: 'Pomme', by: 'Ch@ntarelle' } ], Contributeurs: [ { name: 'AzerTix', by: 'Gameplay' }, { name: 'AzerTix', by: 'Montage' } ], } },
