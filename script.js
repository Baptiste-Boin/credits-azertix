...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const videoDatabase = [
        { id: 'Cities Skylines 2 #1', title: 'Cities Skylines 2 - Bienvenue a Lake Arbor #1', thumbnail: 'https://readdy.ai/api/search-image?query=gaming%2520thumbnail%2520with%2520futuristic%2520UI%2520elements%2C%2520vibrant%2520colors%2C%2520showing%2520a%2520first-person%2520shooter%2520game%2520scene%2520with%2520weapon%2520and%2520HUD%2520elements%2C%2520high%2520quality%2520digital%2520art%2520with%2520dynamic%2520composition%2C%2520perfect%2520for%2520a%2520YouTube%2520gaming%2520video&width=640&height=360&seq=vid1&orientation=landscape', duration: '20:52', date: '28 juillet 2025', views: 'Non definies vues', description: '🎮 Bienvenue à Lake Arbor sur Cities Skylines 2 !
...
🔔 Active la cloche pour ne pas rater l'avancé de Lake Arbor !

📸 Suis-moi ici :
👉 Twitter : @YTAzerTix
👉 Instagram : @YTAzerTix', youtubeLink: '#', credits: { Musique: [ { name: 'Lost in Dreams', by: 'dvine' }, { name: 'Pomme', by: 'Ch@ntarelle' } ], Contributeurs: [ { name: 'AzerTix', by: 'Gameplay' }, { name: 'AzerTix', by: 'Montage' } ], } },
