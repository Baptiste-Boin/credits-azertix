...
    const videoDatabase = [
        { id: 'valorant-pro', title: 'Comment Devenir Pro sur Valorant en 1 Semaine', thumbnail: 'https://readdy.ai/api/search-image?query=gaming%2520thumbnail%2520with%2520futuristic%2520UI%2520elements%2C%2520vibrant%2520colors%2C%2520showing%2520a%2520first-person%2520shooter%2520game%2520scene%2520with%2520weapon%2520and%2520HUD%2520elements%2C%2520high%2520quality%2520digital%2520art%2520with%2520dynamic%2520composition%2C%2520perfect%2520for%2520a%2520YouTube%2520gaming%2520video&width=640&height=360&seq=vid1&orientation=landscape', duration: '18:24', date: '24 juin 2025', views: '245K vues', description: 'Tous les secrets pour améliorer votre gameplay et atteindre le niveau professionnel rapidement.', youtubeLink: '#', credits: { Musique: [ { name: 'Future Drive', by: 'NCS' }, { name: 'Cyberpunk', by: 'Infraction' } ], Contributeurs: [ { name: 'ShadowGamer', by: 'Gameplay' }, { name: 'PixelArtz', by: 'Montage' } ], } },
        { id: 'minecraft-castle', title: 'Minecraft: Construction du Château Ultime (Partie 3)', thumbnail: 'https://readdy.ai/api/search-image?query=gaming%2520thumbnail%2520showing%2520Minecraft%2520with%2520impressive%2520build%2C%2520dramatic%2520lighting%2C%2520epic%2520castle%2520or%2520structure%2C%2520high%2520quality%2520digital%2520art%2520with%2520vibrant%2520colors%2C%2520perfect%2520for%2520a%2520YouTube%2520gaming%2520video%2C%2520professional%2520composition&width=640&height=360&seq=vid2&orientation=landscape', duration: '22:37', date: '20 juin 2025', views: '189K vues', description: 'Finalisation de notre méga-construction avec des techniques avancées et des mods exclusifs.', youtubeLink: '#', credits: { Shaders: [ { name: 'BSL Shaders', by: 'capttatsu' } ], 'Packs de Textures': [ { name: 'Faithful 32x', by: 'Faithful Team' } ], Constructeurs: [ { name: 'BuilderPro', by: 'Design' }, { name: 'RedstoneMaster', by: 'Systèmes' } ] } },
        { id: 'fortnite-skins', title: 'Top 10 Skins Fortnite que Vous Devez Absolument Avoir', thumbnail: 'https://readdy.ai/api/search-image?query=gaming%2520thumbnail%2520showing%2520Fortnite%2520battle%2520royale%2520action%2C%2520character%2520with%2520cool%2520skin%2520in%2520dynamic%2520pose%2C%2520vibrant%2520colors%2C%2520high%2520quality%2520digital%2520art%2520with%2520action%2520composition%2C%2520perfect%2520for%2520a%2520YouTube%2520gaming%2520video%2C%2520professional%2520look&width=640&height=360&seq=vid3&orientation=landscape', duration: '15:42', date: '18 juin 2025', views: '312K vues', description: 'Découvrez les skins les plus rares et les plus stylés disponibles actuellement sur Fortnite.', youtubeLink: '#', credits: { Recherche: [ { name: 'SkinBase', by: 'Données sur la rareté' } ] } },
        { id: 'lol-guide', title: 'Guide Complet du Nouveau Champion League of Legends', thumbnail: 'https://readdy.ai/api/search-image?query=gaming%2520thumbnail%2520showing%2520League%2520of%2520Legends%2520champion%2520in%2520battle%2C%2520epic%2520ability%2520effects%2C%2520dramatic%2520lighting%2C%2520high%2520quality%2520digital%2520art%2520with%2520vibrant%2520colors%2C%2520perfect%2520for%2520a%2520YouTube%2520gaming%2520video%2C%2520professional%2520composition&width=640&height=360&seq=vid4&orientation=landscape', duration: '20:15', date: '15 juin 2025', views: '178K vues', description: 'Maîtrisez toutes les compétences et combos du dernier champion ajouté au jeu.', youtubeLink: '#', credits: {} },
        { id: 'cod-meta', title: 'Les Meilleures Armes de Call of Duty: Warzone 2025', thumbnail: 'https://readdy.ai/api/search-image?query=gaming%2520thumbnail%2520showing%2520Call%2520of%2520Duty%2520action%2520scene%2C%2520soldier%2520with%2520weapon%2C%2520explosion%2520effects%2C%2520dramatic%2520lighting%2C%2520high%2520quality%2520digital%2520art%2520with%2520intense%2520composition%2C%2520perfect%2520for%2520a%2520YouTube%2520gaming%2520video%2C%2520professional%2520look&width=640&height=360&seq=vid5&orientation=landscape', duration: '25:08', date: '10 juin 2025', views: '295K vues', description: 'Analyse complète du meta actuel et des meilleures configurations d\'armes pour dominer.', youtubeLink: '#', credits: {} },
        { id: 'among-us-strats', title: 'Among Us: Les Stratégies Secrètes d\'Imposteur', thumbnail: 'https://readdy.ai/api/search-image?query=gaming%2520thumbnail%2520showing%2520Among%2520Us%2520characters%2520in%2520funny%2520situation%2C%2520colorful%2520style%2C%2520impostor%2520reveal%2C%2520high%2520quality%2520digital%2520art%2520with%2520humorous%2520composition%2C%2520perfect%2520for%2520a%2520YouTube%2520gaming%2520video%2C%2520professional%2520look&width=640&height=360&seq=vid6&orientation=landscape', duration: '17:33', date: '05 juin 2025', views: '221K vues', description: 'Apprenez à tromper vos amis comme un pro avec ces techniques d\'impostor avancées.', youtubeLink: '#', credits: {} }
    ];
...
        const creditDetails = document.getElementById('form-credit-details').value;

        // Simule l'envoi, par exemple en ouvrant un client mail
        const recipient = 'contact@azertix.com';
        const subject = encodeURIComponent('Rapport de Crédit Manquant pour Azertix');
        const body = encodeURIComponent(
            `Bonjour,\n\nVoici un rapport de crédit manquant :\n\n` +
            `URL de la vidéo : ${videoUrl}\n` +
            `Email du rapporteur : ${contactEmail || 'Non fourni'}\n\n` +
            `Détails :\n${creditDetails}\n\n` +
            `Cordialement.`
        );
...
        alert("Merci ! Votre rapport a été préparé pour être envoyé par email.");
    });
