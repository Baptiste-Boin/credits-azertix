...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const videoDatabase = [
        { id: 'Cities Skylines 2 #1', title: 'Cities Skylines 2 - Bienvenue a Lake Arbor #1', thumbnail: 'https://i.imgur.com/XYZ123.png', duration: '20:52', date: '28 juillet 2025', views: 'Non definies vues', description: 'Hello World', youtubeLink: '#', credits: { Musique: [ { name: 'Lost in Dreams', by: 'dvine' }, { name: 'Pomme', by: 'Ch@ntarelle' } ], Contributeurs: [ { name: 'AzerTix', by: 'Gameplay' }, { name: 'AzerTix', by: 'Montage' } ], } },
